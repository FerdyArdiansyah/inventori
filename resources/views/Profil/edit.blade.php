                    ...
                    <div class="card-body">
                        <form action="{{route('profil.update', $profil->id)}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tempat_lahir" id="tempat lahir" value="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="tanggal_lahir">Tanggal Lahir</label>
                                <input type="text" name="tanggal_lahir" id="tanggal lahir" value="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="jenis_kelamin">Jenis Kelamin</label>
                                <input type="text" name="jenis_kelamin" id="jenis kelamin" value="" class="form-control">
                            </div>
                            <div class="form-group">
